...
public class BinaryTree<E> implements Serializable {
    ...
    /**
     * Performs a post-order traversal of this tree.
     *
     * @param node The local root
     * @param depth The current level in depth of this tree
     * @param sb The String buffer which accumulates the output
    ...
    */
    ...
    public String toString2() {
        ...
        // Used to determine the actual number of nodes on the next level as we store null's for empty space.
        int nodesOnNextLayer = 0;
        do {
            // Store all the node data at the current level in order to add it to the List of all lines after 
            // completion.
            List<String> currentLine = new ArrayList<String>();
            
            // Reset the counter of actual nodes for the next layer.
            nodesOnNextLayer = 0;
            ...
            for (Node<E> currentNode : currentLevel) {
                if (currentNode == null) {
                    ...
                    // Indicate that we have more nodes to explore.
            ...
            nextLevel = tmp;
            nextLevel.clear();
        } while (nodesOnNextLayer > 0);
        // Stop when there are no more nodes on the next level.
        // This means we have traversed down the longest branch and every node on the current level was a leaf.
